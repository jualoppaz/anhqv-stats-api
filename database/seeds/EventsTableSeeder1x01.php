...
class EventsTableSeeder1x01
{
  ...
  public function getEvents_1x01()
  {
    ...
    $events_1x01_48 = $this->getEvents_1x01_48($scenes_1x01[$index++]);
    ...
    $res = array_merge(
      ...
      $events_1x01_45, $events_1x01_46, $events_1x01_47, $events_1x01_48,
    );
  ...
  public function getEvents_1x01_05($scene_id)
  {
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => '¿40 minutos? Suficiente para estrellarse.',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
  ...
  /**
   * Eventos de la escena 44 del capitulo 1x01
   */
  public function getEvents_1x01_44($scene_id)
  {
    $events = [];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Bueno, ¿cuál de los dos va a dormir en el sofá?',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Nooo, como sólo somos amigos.',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Va, no empecemos... ¿Qué le importa a esta gente lo que somos o no somos?',
      static::FIELD_CHARACTERS_ID => [$fernandoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Eh, eh, eh. Yo tengo muy claro quién soy. Pero parece ser que tú no.',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Ven aquí. Siéntate... Escúchame, están a punto de ascenderme en el bufete.',
      static::FIELD_CHARACTERS_ID => [$fernandoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'No creo que sea un buen momento para salir del armario.',
      static::FIELD_CHARACTERS_ID => [$fernandoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Fernando, no es que tú no quieras salir del armario, es que te has escondido en el cajón de los calcetines. Me voy al sofá.',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => '¿No piensas hacer nada? ¿Voy a tener que dormir aquí?',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Anda, ven. Tontito.',
      static::FIELD_CHARACTERS_ID => [$fernandoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Vale, te perdono.',
      static::FIELD_CHARACTERS_ID => [$mauriId],
    ];
  ...
  /**
   * Eventos de la escena 45 del capitulo 1x01
   */
  public function getEvents_1x01_45($scene_id)
  {
    $events = [];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Es la primera vez que veo un pene.',
      static::FIELD_CHARACTERS_ID => [$vicentaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'No sé, yo me esperaba otra cosa.',
      static::FIELD_CHARACTERS_ID => [$vicentaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Eso nos pasa a todas, hija.',
      static::FIELD_CHARACTERS_ID => [$marisaId],
    ];
  ...
  /**
   * Eventos de la escena 46 del capitulo 1x01
   */
  public function getEvents_1x01_46($scene_id)
  {
    $events = [];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Pues, es bonito esto de emanciparse, jum. Ahora entiendo por qué hemos esperado 30 años.',
      static::FIELD_CHARACTERS_ID => [$robertoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Todos los comienzos siempre son difíciles. Dentro de unos años nos acordaremos de esto y nos reiremos.',
      static::FIELD_CHARACTERS_ID => [$luciaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Yo creo que no.',
      static::FIELD_CHARACTERS_ID => [$robertoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Oye, por cierto. Tengo que llamar a los del seguro, a los de la mudanza, que no han venido; a...',
      static::FIELD_CHARACTERS_ID => [$luciaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Sí, sí han venido. Nuestras cosas están en el portal.',
      static::FIELD_CHARACTERS_ID => [$robertoId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Y ¿por qué no me has dicho nada?',
      static::FIELD_CHARACTERS_ID => [$luciaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Lo siento, cariño. Estaba muy ocupado enseñándole el culo al vecindario. Sí, sí, tú ríete. Pero van a pensar que soy un degenerado.',
      static::FIELD_CHARACTERS_ID => [$robertoId],
    ];
  ...
  /**
   * Eventos de la escena 48 del capitulo 1x01
   */
  public function getEvents_1x01_48($scene_id)
  {
    $events = [];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Pero bueno, pero ¿es que nadie va a sacarnos de aquí? Se nos va a acabar el oxígeno...',
      static::FIELD_CHARACTERS_ID => [$emilioId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => '¿Cómo se nos va a acabar el oxígeno? Esto estará ventilado...',
      static::FIELD_CHARACTERS_ID => [$aliciaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Sí, con el tiempo que hace que no limpio yo la rejilla...',
      static::FIELD_CHARACTERS_ID => [$emilioId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Bueno, me toca. Veo, veo...',
      static::FIELD_CHARACTERS_ID => [$belenId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Un portero gilipollas.',
      static::FIELD_CHARACTERS_ID => [$belenId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Eh, cuidadito, ¿señorita Belén? Sin ofender, ¿eh?',
      static::FIELD_CHARACTERS_ID => [$emilioId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Ya. Vamos a jugar en serio, venga.',
      static::FIELD_CHARACTERS_ID => [$aliciaId],
    ];
    ...
    $events[] = [
      ...
      static::FIELD_ORDER => count($events) + 1,
      static::FIELD_TYPE => static::VALUE_DIALOG,
      static::FIELD_TEXT => 'Una... que se ha quedado sin cita.',
      static::FIELD_CHARACTERS_ID => [$emilioId],
    ];
